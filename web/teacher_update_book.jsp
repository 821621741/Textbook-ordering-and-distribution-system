...
<head>
    ...
    <%
        ...
        if("是".equals(request.getParameter("CCissue_flag"))){
            request.setAttribute("msg1","教材已发放！！ 无法添加或更新教材");
            request.getRequestDispatcher("/CourseServlet?option=ShowAllCoursesByTeacher").forward(request,response);
        }
        else if("未设置".equals(request.getParameter("CCset_flag"))){
            request.setAttribute("msg1","教材未设置！！无法进行更新教材");
            request.getRequestDispatcher("/CourseServlet?option=ShowAllCoursesByTeacher").forward(request,response);
        }
    %>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <%
                ...
                String CCbno=request.getParameter("CCbno");
            %>
            <!-- Begin Page Content -->
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary">更改教材</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                            ...
                                            <%--<thead>--%>
                                            <tr>
                                                <td width="130">所属教师号</td>
                                                <td>
                                                    <input type="text" name="Tno" value="${sessionScope.user.tno}" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="130">所属课程号</td>
                                                <td>
                                                    <input type="text" name="Ccno" value="<%out.print(ccno);%>" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="130">班级</td>
                                                <td>
                                                    <input type="text" name="CCmno" value="<%out.print(mno);%>" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="130">书号</td>
                                                <td>
                                                    <input type="text" name="Bno"value="<%out.print(CCbno);%>">
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                ...
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-check"></i>
                                                        ...
                                                        <button class="text">确认更改</button>
                                                        <input style="display:none" name="option" value="UpdateCourseAndReserve">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
