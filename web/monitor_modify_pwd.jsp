...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Begin Page Content -->
            <form action="ModifyPwdServlet">
                <div class="container-fluid">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h4 class="m-0 font-weight-bold text-primary">修改密码信息</h4>
                        <c:if test="${msg1 != null}">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                        ...
                                        <thead>
                                        <tr>
                                            <td width="180">请输入原来的密码</td>
                                            <td>
                                                <input type="password" name="oldpassword" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="180">请输入新密码</td>
                                            <td>
