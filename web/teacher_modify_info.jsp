        ...
        <div id="content">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h3 class="m-0 font-weight-bold text-primary">我的个人信息</h3>
                    <c:if test="${msg != null}">
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                        ...
                                        <tr>
                                            <td width="130">邮箱</td>
                                            <td><%
                                                out.println(teacher1.getTemail());
                                            %></td></td>
                                    ...
                                    <table style="margin: 0px auto">
                                        <tr>
                                            <td>
                                                <a href="teacher_update_info.jsp" class="btn btn-info btn-icon-split" >
                                                <span class="icon text-white-50">
