...
<head>
    ...
    <%
        ...
        else if("已设置".equals(request.getParameter("CCset_flag"))){
            request.setAttribute("msg1","教材已设置无法再次添加，若要更改教材请点击更新教材。");
            request.getRequestDispatcher("/CourseServlet?option=ShowAllCoursesByTeacher").forward(request,response);
        }
    %>
            ...
            <form action="ReserveServlet">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h4 class="m-0 font-weight-bold text-primary">添加教材订单</h4>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <span class="icon text-white-50">
                                                    ...
                                                    <button class="text">确认添加</button>
                                                    <input style="display:none" name="option" value="AddReserve">
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
